//SPDX-License-itemIdentifier: MIT
...
contract MarketPlace {
    struct Items {
        uint256 itemId;
        string itemName; // string type used only for the purpose of this demo
        uint256 price;
    ...
    function getProductitemId() external view returns (uint256) {
